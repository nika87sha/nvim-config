-- /home/verodg/.config/nvim/lua/plugins/which-key.lua
...
return {
  ...
  config = function()
    ...
    local normal_mappings = {
        ...
        { '<leader>et', ':Neotree<cr>', desc = 'Explore Tree' },
        ...
        { '<leader>na', ':lua require("snacks").scratch.select()<cr>', desc = 'Select Scratch' },
        { '<leader>ns', ':lua require("snacks").scratch()<cr>', desc = 'New Scratch' },

        { '<leader>o', group = ' Options' },
        { '<leader>oi', 'vim.show_pos', desc = 'Inspect Position' },
        { '<leader>oN', ':lua require("snacks").notifier.show_history()<cr>', desc = 'Notification History' },
