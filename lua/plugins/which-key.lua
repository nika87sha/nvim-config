...
return {
  ...
  config = function()
    ...
    -- Normal mappings (tal cual los tenías)
    local normal_mappings = {
      ...
      -- 🎨 Colors
      { '<leader>cc', ':CccHighlighterToggle<cr>', desc = 'Toggle Highlight' },
      ...
      { '<leader>ne', ':Tdo entry<cr>', desc = "Today's Entry" },
      { '<leader>nf', ':Tdo files<cr>', desc = 'All Notes' },
      { '<leader>ng', ':Tdo find<cr>', desc = 'Find Notes' },
      { '<leader>nh', ':Tdo -1<cr>', desc = "Yesterday's Todo" },
      { '<leader>nl', ':Tdo 1<cr>', desc = "Tomorrow's Todo" },
      { '<leader>nn', ':Tdo note<cr>', desc = 'New Note' },
      { '<leader>np', group = 'Past Todos' },
      { '<leader>ns', ':lua Snacks.scratch()<cr>', desc = 'New Scratch' },
      { '<leader>nt', ':Tdo todos<cr>', desc = 'Incomplete Todos' },
      { '<leader>nx', ':Tdo toggle<cr>', desc = 'Toggle Todo' },
